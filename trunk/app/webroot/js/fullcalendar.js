...
function BasicView(element, calendar, viewName) {
	...
	function buildCellHTML(date) {
		...
		if (showNumbers) {
		    var tt = window.location.href.toString().replace('/index', '');
			if (auth_number == '1' || auth_number == '4') html += "<div class='fc-day-number'><a href='"+webroot+"calendar/register/"+formatDate(date, 'yyyy-MM-dd')+"'></li>" + date.getDate() + "</a></div>";
			 else html += "<div class='fc-day-number' ><span style='text-decoration: none;'></li>" + date.getDate() + "</span></div>";
		}
