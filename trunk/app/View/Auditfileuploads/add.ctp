...
<script type="text/javascript">
    $(function() {
        $('.fileUpload').fileUploader({
            ...
            allowedExtension: '',
            timeInterval: [10, 20, 40, 20, 10, 50], //Mock percentage for iframe upload
    ...
    function hideTempu1() {
        document.getElementById('AuditfileuploadFile').click();
...
if (isset($version) && $version < 10) {
    ...
    <fieldset>
        ...
        <div class="fileuploads form">
            <?php echo $this->Form->create('Auditfileupload', array('type' => 'file')); ?>
            <?php
