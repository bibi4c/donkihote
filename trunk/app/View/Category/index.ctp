...
<table id="serchfield">
    ...
    <tr>
        <th>有効開始日</th>
        <td colspan="3">
            <?php echo $this->Form->input('start_date1', array('label' => false, 'class' => 'shortern timePicker', 'value' => $search['searchForm']['start_date1'], 'type' => 'text', 'div' => FALSE)); ?>
            〜
            <?php echo $this->Form->input('start_date2', array('label' => false, 'class' => 'shortern timePicker', 'value' => $search['searchForm']['start_date2'], 'type' => 'text', 'div' => FALSE)); ?>
        </td>
    </tr>
    ...
    <tr>
        <th>有効終了日</th>
        <td colspan="3">
            <?php echo $this->Form->input('end_date1', array('label' => false, 'class' => 'shortern timePicker', 'value' => $search['searchForm']['end_date1'], 'type' => 'text', 'div' => FALSE)); ?>
            〜
            <?php echo $this->Form->input('end_date2', array('label' => false, 'class' => 'shortern timePicker', 'value' => $search['searchForm']['end_date2'], 'type' => 'text', 'div' => FALSE)); ?>
        </td>
    </tr>
    <tr>
        <td colspan="6">
...
<div id="resultSummary">
    <div id="resultAction">
        <?php echo $this->Html->link('新規作成', array('controller' => 'Document', 'action' => 'register'), array('class' => 'btnStandard linkCanceller posright postop', 'style' => '')); ?>
    </div>
    <div id="resultCount">
