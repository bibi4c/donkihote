<div class="mainarea">
    ...
    <?php echo $this->Form->create('Store', array('url' => array('controller' => 'Store', 'action' => 'register_confirm'))); ?>
    <table id="summaryField">
        ...
        <tr>
            ...
            <td>
                ...
                echo $this->Form->hidden('puroperty_id', array('label' => false, 'value' => $store_data['Store']['puroperty_id']));
                ?>
            </td>
        ...
        <tr>
            ...
            <td colspan="5">
                <?php
                //echo $store_data['Store']['valid_end_day'];
...
<?php echo $this->Html->link('キャンセル', array('controller' => 'Store', 'action' => 'register'), array('class' => 'btnCanceller linkCanceller posLeft')); ?>
