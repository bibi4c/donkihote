<div class="mainarea">
	...
	<?php 
	echo $this->Form->create('User_confirm', array('url' => array('controller' => 'User', 'action' => 'change_confirm')));?>
	<table id="summaryField">
		...
		<tr>
			...
			<td>
				...
				echo $this->Form->hidden('password', array('label'=>false,'type'=>'text' ,'value'=>$user_data['User']['password'],'style'=>'background:white;border:none;'));?>
			</td>
		</tr>
		<tr>
			<th>権限</th>
	...
	<div id="actionField" class="clearfix">
		 <?php echo $this->Html->link('キャンセル', array('controller'=>'User', 'action'=>'view',$user_data['User']['user_id']), array('class'=>'btnCanceller linkCanceller posLeft'));?>
