...
<?php echo $this->Form->create('User',array('url'=>array('type'=>'post','controller'=>'User','action'=>'view',$user_info['user_id'])));?>
				...
				<tr>
                    ...
                    <?php 
                    	...
                    	echo $this->Form->hidden('user_id',array('type'=>'text','style'=>'width: 190px;','value'=>$user_info['user_id'],'label'=>false, 'required' => FALSE,));?>
                    </td>
				</tr>
                     ...
                     <tr>
	                    <th>パスワード</th>
	                     ...
	                     <?php 
	                    	...
	                    	echo $this->Form->input('password',array('type'=>'text','style'=>'width: 190px;','value'=>$user_info['password'],'label'=>false,'required' =>FALSE));
	                    ?>
	                     </td>
                  </tr>
                <tr>
				...
				<tr>
                    <th>メールアドレス</th>
                     <td>
                     <?php echo $this->Form->input('mail_address',array('type'=>'text','style'=>'width: 190px;','required'=>FALSE,'div'=>false,'label'=>false,'value'=>$user_info['mail_address']));?>
                     </td>
                     </tr>
                <tr>
                    <th>有効／無効</th>
